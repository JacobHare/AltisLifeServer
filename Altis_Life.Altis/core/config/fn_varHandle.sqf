...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "cocaineu": {"life_inv_coke"};
			case "cocainep": {"life_inv_cokep"};
			case "spikeStrip": {"life_inv_spikeStrip"};
			case "cement": {"life_inv_cement"};
			case "crushedrock": {"life_inv_crushedrock"};
			case "rock": {"life_inv_rock"};
			case "jailrock": {"life_inv_jailrock"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_coke": {"cocaineu"};
			case "life_inv_cokep": {"cocainep"};
			case "life_inv_spikeStrip": {"spikeStrip"};
			case "life_inv_cement": {"cement"};
			case "life_inv_crushedrock": {"crushedrock"};
			case "life_inv_rock": {"rock"};
			case "life_inv_jailrock": {"jailrock"};
