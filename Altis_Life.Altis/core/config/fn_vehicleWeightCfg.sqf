...
switch (_className) do
{
	...
	case "O_Heli_Light_02_unarmed_F": {190};
	case "I_Heli_Transport_02_F": {280};
	case "B_Heli_Transport_01_F": {200};
	case "O_Heli_Transport_04_F": {150;};
	case "O_Heli_Transport_04_bench_F": {150;};
	case "O_Heli_Transport_04_covered_F": {175;};
	case "I_Heli_light_03_unarmed_F": {200};
	case "B_Heli_Transport_03_unarmed_F": {500;};
	
	case "I_Plane_Fighter_03_AA_F": {50};
	case "B_Plane_CAS_01_F": {50};
	case "O_Plane_CAS_02_F": {50};
