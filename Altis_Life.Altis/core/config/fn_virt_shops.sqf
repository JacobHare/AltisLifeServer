...
switch (_shop) do
{
	...
	case "donator": {["Altis Donator Market",["water","rabbit","apple","redgull","cornmeal","bottles","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","storagesmall","storagebig"]]};
	...
	case "crushedrock": {["Pay Warden",["crushedrock","pickaxe"]]};
