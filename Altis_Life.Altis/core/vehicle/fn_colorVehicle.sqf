...
{
	_vehicle setObjectMaterial [0,"\A3\data_f\mirror.rvmat"];
};
if (_texture2 == "CHROME") then
{
	_vehicle setObjectMaterial [1,"\A3\data_f\mirror.rvmat"];
};
if (_texture3 == "CHROME") then
{
	_vehicle setObjectMaterial [2,"\A3\data_f\mirror.rvmat"];
};
